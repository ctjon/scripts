...
export SRCDIR=rsync://mirrors.syringanetworks.net/OpenBSD
#export TGTDIR=/export/install/OpenBSD # for server0
export TGTDIR=/Volumes/Data/Install/OpenBSD # for mbp
